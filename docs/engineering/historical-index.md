...
- CURRENT AUTHORITY — [AGENTS.md](../../AGENTS.md): repository operating rules at the actual reviewed checkout. The historical reconciliation at `806657aecdb4d9ced25cd1f52020ae2870af02ac` is separately indexed below; copying this index does not replace the manual. For repository operating rules it is subordinate to explicit current human decisions; fresh live repository/GitHub observation controls directly observable facts.
...
## 2026-09-18 reconciliation additions

- CURRENT AUTHORITY — [Progress reconciliation](progress-reconciliation-2026-09-18.md): exact integration scope, fresh checks, resulting commit and publication observation maintained by the coordinator. Pending fields are not completed gates.
- PUBLISHED CANONICAL DOCUMENTS — [Canonical Structr Truth v1](../product/canonical-structr-truth-v1.md) and [feature-evidence procedure](../product/feature-evidence-maintenance.md): published through PRs #12/#13, main observed at `8fa14da3e9c275645c0f7b4fd67dcc5a3ebc6dcf`. Publication does not re-anchor or reverify all 48 capability rows.
- HISTORICAL CLOSED WORKFLOW — Phase 1/Phase 2 Tasks 1–6 at published `f60cf9a56679d4d7083b2c11ac4e2727d53d84c3`. Task-specific earlier snapshots are not today's next-action authority. The local 17 September snapshot at `0db4499cc6be577d1c1bf408c624968a7c7f67e3` remains historical and is superseded for current-state facts.
- APPROVED DESIGN ONLY — [G4b ownership design](../security/g4b-catalog-ownership/2026-09-17-design.md), closed at `8c2fdfb630933259998fa98616b2ae08e2ce32ad`. [G4b-1 Recover](../security/g4b-catalog-ownership/2026-09-17-g4b-1-recover-design.md) and [correction](../security/g4b-catalog-ownership/2026-09-17-g4b-1-recover-correction.md) retain NO-GO/STOP. These dated records do not represent a new live database inspection.
- LOCAL ACCEPTED PREDECESSORS — [Lineage](integration-lineage-2026-09-18.md), [type maintenance](sprint17-type-maintenance-2026-09-18.md), [seed atomicity](coastal-seed-atomicity-2026-09-18.md), [Review state](review-overrides-query-state-2026-09-18.md), [parent characterization](../security/g2-preview-parent-characterization-20260918.md), [preset audit](preset-delete-audit.md) and [bundle transactions](bundle-item-transactions.md): bounded implementation/evidence. Later final mission reports supersede intermediate pending-review wording; they do not establish global safety or new integrated test results.
- LOCAL LABORATORY / READINESS PREDECESSOR — [Laboratory](ed-pilot-lab.md), [taxable preservation](jobtread-taxable-preservation.md), [approval entrypoint](estimate-approval-entrypoint.md), [readiness UI](../estimate-readiness-ui-2026-09-18.md): internal isolated proof and candidate changes, not production delivery. Final integration identities and any sanitized copies are attributed in the coordinator report.
- PROPOSED / PREPARATION ONLY — [Current planning](../../plans/current-sprint.md), [commercial scope](../product/commercial-authorization-first-delivery.md), [technical design v3](../product/proposal-issuance-technical-design-v3.md), [implementation plan and dated preparation results](../product/proposal-issuance-implementation-plan.md), [source contract](../product/proposal-source-contract.md), [local PostgreSQL preparation procedure](../product/postgres-preparation-tests.md) and [historical F5b design](../../plans/f5b-pilot-design.md). Executable C-20 preparation artifacts remain excluded; historical generic-approval characterization is superseded by the candidate guard.
- PAUSED / NOT INTEGRATED — Internal-crew period-audit design and local demonstration. No persisted hours/payroll module, payment event, actual-cost posting or canonical capability promotion is inferred.
