...
describe("G2 seed discovery only", () => {
  it("seedCoastalRules does not seed or report success after discovery fails", async () => {
  ...
  it("seedCoastalRules checks existing rules in the administrator's tenant before deciding to skip", async () => {
